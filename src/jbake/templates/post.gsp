<%include "header.gsp"%>
	...
	<div class="page-header">
        <div class="row">
            <div class="col-xs-4 col-md-2"><img src="${content.rootpath}img/eformat.me.jpg"></div>
    ...
    <div class="row">
        ...
        <!--a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.eformat.me/${content.uri}" data-via="eformat" data-text="${content.title}" data-lang="en">Tweeter</a-->
        <!--script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script-->
        <div class="g-plusone" data-size="medium" data-href="http://www.eformat.me/${content.uri}"></div>
