    ...
    <div id="footer">
      <div class="container">
        ...
        <p class="text-muted credit">&copy; 2022 | Baked with <a href="http://jbake.org">JBake ${version}</a><a href="https://github.com/eformat/blog.eformat.me/actions"> | Published ${published_date}</a></p>
      </div>
    </div>
