...
Hopefully in an upcoming OpenShift relaease (4.13 or 4.14) we will be able to use the *new API's for CRDs ImageDigestMirrorSet ImageTagMirrorSet* - see https://issues.redhat.com/browse/OCPNODE-521[Allow mirroring images by tags] REF for more details on these changes.
